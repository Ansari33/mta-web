             ...
             <form action="/update_s" method="POST" enctype="multipart/form-data">
                                ...
                                <script type="text/javaScript">
                                  var p = document.getElementById('tipe').value;
                                    console.log(p);
                                 var p = document.getElementById('tipe').value={!!$data->tipe!!};
                                </script>
                                @endif
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Soal</label>
                                    <div class="col-sm-10">
                                    <textarea name="soal" id="" cols="100" class="form-control" rows="3">{{$data->soal}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Yes 1</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="a" class="form-control" id="inputEmail3" placeholder="Pilihan A" required="" value="{{$data->a}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Yes 2</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="b" class="form-control" id="inputEmail3" placeholder="Pilihan B" required="" value="{{$data->b}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Yes 3</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="c" class="form-control" id="inputEmail3" placeholder="Pilihan C" required="" value="{{$data->c}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Yes 4</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="d" class="form-control" id="inputEmail3" placeholder="Pilihan D" required="" value="{{$data->d}}">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Jawaban</label>
                                    <div class="col-sm-10">
                                        <input type="text" name="jawaban" class="form-control" id="inputEmail3" placeholder="jawaban" required="" value="{{$data->jawaban}}">
                                    </div>
                                </div>
