...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <h4 class="tittle-w3-agileits mb-4" draggable="true">Semua Soal</h4>
            <table class="table table-hover" dragable="true">
            <th>Soal </th>
            <th>Jenis</th>
            <th>Tipe</th>
            <th>Aksi</th>
            ...
            <tr> 
                ...
                <td>{{$s->jenis}}</td>
                <td>{{$s->tipe}}</td>
                <td><a href="/edit_s/{{$s->id}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a></td>
            </tr>
            @endforeach
            </table>
            {{$soal->links()}}
