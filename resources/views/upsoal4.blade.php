            ...
            <h4 class="tittle-w3-agileits mb-4">Edit Data Soal</h4>
             <form action="/update_s" method="POST" enctype="multipart/form-data">
                                ...
                                @endif
                                    ...
                                    <div class="col-sm-10">
                                    <textarea name="soal" id="" cols="100" class="form-control" rows="3">
                                        {{$soal->soal}}
                                    </textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">gambar Soal</label>
                                    <div class="col-sm-10">
                                    <input type="file" name="gsoal" id="" cols="100" class="form-control" rows="3">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Soal 1</label>
                                    <div class="col-sm-10">
                                    <textarea name="soal1" id="" cols="100" class="form-control" rows="3">{{$soal->soal41}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Pilihan soal 1</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pilihan1" value="{{$soal->pilihan1}}">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Soal 2</label>
                                    <div class="col-sm-10">
                                    <textarea name="soal2" id="" cols="100" class="form-control" rows="3">{{$soal->soal42}}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Pilihan soal 2</label>
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="pilihan2" value="{{$soal->pilihan2}}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="jawaban" value="{{$soal->jawaban}}">
                                    </div>
                                </div>
